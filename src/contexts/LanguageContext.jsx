...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      unsubscribeTitle: "Users can unsubscribe by sending the following messages to ####",
      ...
      daily: "To subscribe daily (3 birr) send A to ####",
      weekly: "To subscribe weekly (15 birr) send B to ####",
      monthly: "To subscribe monthly (75 birr) send C to ####",
    ...
    am: {
      ...
      unsubscribeTitle: "ተጠቃሚዎች ከደንበኝነት ምዝገባው ለመውጣት (ለመሰረዝ) የሚከተሉትን መልዕክቶች ወደ #### መላክ ይችላሉ፦",
      ...
      daily: "ለዕለታዊ ለመመዝገብ (3) A ወደ #### ይላኩ",
      weekly: "ለሳምንታዊ ለመመዝገብ (15) B ወደ #### ይላኩ",
      monthly: "ለወርሃዊ ለመመዝገብ (75) C ወደ #### ይላኩ",
      logging_in: "በመግባት ላይ...",
